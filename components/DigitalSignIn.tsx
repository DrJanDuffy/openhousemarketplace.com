  ...
  return (
    <div className={`bg-white rounded-lg shadow-md p-6 ${className}`}>
      <div className="text-center mb-6">
        ...
        <h3 className="text-xl font-bold text-gray-900 mb-2">Schedule a Private Tour</h3>
      ...
      <CalendlyPopupLink className="w-full flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium mb-6">
